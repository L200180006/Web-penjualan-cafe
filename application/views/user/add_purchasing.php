<div class="container-fluid">
    ...
    <form class="user" method="POST" action="<?= base_url('user/add_purchasing'); ?>">

        <div class="col-lg-9 mx-auto">
            <div class="p-5">
                <div class="form-group">
                    <label>Item</label>
                    <input type="text" class="form-control" id="nama_item" name="nama_item" placeholder="Item" value="<?= set_value('nama_item'); ?>">
                    <?= form_error('nama_item', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label>Price</label>
                    <input type="text" class="form-control number-cleave" id="harga_item" name="harga_item" placeholder="Rp." value="<?= set_value('harga_item'); ?>">
